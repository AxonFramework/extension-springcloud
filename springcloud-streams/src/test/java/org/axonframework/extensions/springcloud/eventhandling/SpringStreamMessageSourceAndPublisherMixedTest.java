...
@DirtiesContext
class SpringStreamMessageSourceAndPublisherMixedTest {
    ...
    private SpringStreamMessagePublisher messagePublisher;
    ...
    void setUp() {
        ...
        converter = DefaultSpringMessageConverter.builder()
                ...
                .build();
        messagePublisher = SpringStreamMessagePublisher.builder()
                .messageSource(eventBus)
                .converter(converter)
                .build();
        messageSource = SpringStreamMessageSource.builder()
                .converter(converter)
                .build();
        messagePublisher.setOutputChannel(testChannels.output());
        testChannels.input().subscribe(messageSource);
    }

    @AfterEach
    void clean() {
        testChannels.input().unsubscribe(messageSource);
    }

    @Test
    void testMessageListenerInvokes() {
